  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContentText style={{ fontSize: '15px',margin:'15px 15px ' }}>Copy and paste the below codes into your blog or website</DialogContentText>
        <TextField
          multiline
          rows={6}
          value={title ==="contributorOverTime" ?OverTimevalue :MonthlyActivevalue }
          variant="outlined"
          style={{ width: '95%', margin: '0 auto 10px',padding:'0',fontSize:'10px' }}
